...
# Define paths
section_dir = '/mnt/c/Users/dev/Desktop/dev/FE/vibe_coding_project/section1'
text_file_name = 'section1 바이브코딩 AI와 함께하거나 도태되거나(박종천).txt'
output_md_file_name = 'section1_강의_요약_통합본_최종.md'
