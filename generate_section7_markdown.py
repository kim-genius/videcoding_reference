...
# Define paths
section_dir = '/mnt/c/Users/dev/Desktop/dev/FE/vibe_coding_project/section7'
text_file_name = 'section7 바이브코딩의 꽃! AI 에이전트의 세계(전현준).txt'
output_md_file_name = 'section7_강의_요약_통합본_최종.md'
