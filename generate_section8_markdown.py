...
# Define paths
section_dir = '/mnt/c/Users/dev/Desktop/dev/FE/vibe_coding_project/section8'
text_file_name = 'section8 당신의 프롬프트가 그저 작문인 이유(강수진).txt'
output_md_file_name = 'section8_강의_요약_통합본_최종.md'
